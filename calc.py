...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cbutt = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.press_it("C") )
        ...
        self.dotbutt = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.press_it("."))
